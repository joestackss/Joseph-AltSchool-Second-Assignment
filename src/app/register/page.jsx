...
const RegisterPage = () => {
  return (
    <div className=" flex justify-center items-center h-screen  w-[80%] mx-auto">
      ...
      {/* First Section */}
      <div className="w-1/2 hidden sm:flex h-full justify-center items-center flex-col bg-[#f7fdfc] ">
        <div className="w-[90%] flex flex-col items-start justify-start space-y-4">
          <svg
            width="98"
            height="100"
            viewBox="0 0 98 100"
          ...
          <h2 className="text-[40px] font-[700] text-center leading-[50px]">
            For Individuals
          </h2>

          <p className="text-[16px] font-[400] text-[#737373] w-[70%]">
